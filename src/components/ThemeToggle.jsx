...
function ThemeToggle({ isDark, onToggle }) {
  return (
    <div className="fixed bottom-4 left-4 z-50">
      <button
        onClick={onToggle} // Ensure this triggers the theme toggle logic
        className="bg-white dark:bg-gray-800 hover:bg-gray-100 dark:hover:bg-gray-700 rounded-lg p-3 shadow-lg flex items-center space-x-2 border border-gray-200 dark:border-gray-700 transition-colors"
